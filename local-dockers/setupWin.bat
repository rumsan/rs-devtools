...
if not exist "data/ganache" mkdir "data/ganache"
if not exist "data/ipfs/data" mkdir "data/ipfs\data"
if not exist "data/ipfs/ipfs" mkdir "data/ipfs\ipfs"
if not exist "data/ipfs/ipns" mkdir "data/ipfs\ipns"
